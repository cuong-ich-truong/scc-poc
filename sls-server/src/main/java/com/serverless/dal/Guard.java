...
public class Guard {
    ...
    public String toString() {
        return String.format("Guard [id=%s, username=%s, firstname=%s, token=%s]", this.id, this.username, this.firstname, this.token);
    }
    ...
    public Guard updateToken(String id, String token) {
        Guard guard = this.mapper.load(Guard.class, id);
        logger.info("Guard - load(): record - " + guard.toString());
    ...
    public void save(Guard record) {
        logger.info("Guard - save(): " + record.toString());
