...
public class Camera {
    ...
    public String toString() {
        return String.format("Camera [id=%s, name=%s]", this.id, this.name);
    }

    // methods
    public Boolean ifTableExists() {
        return this.client.describeTable(CAMERA_TABLE_NAME).getTable().getTableStatus().equals("ACTIVE");
    }
    ...
    public Boolean delete(String id) throws IOException {
        ...
        record = get(id);
        if (record != null) {
          logger.info("Cameras - delete(): " + record.toString());
          this.mapper.delete(record);
        } else {
          logger.info("Cameras - delete(): record - does not exist.");
          return false;
        }
        return true;
    }
